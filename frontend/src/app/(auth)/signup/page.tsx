...
export default function SignupPage() {
    ...
    // NEW: Separate states for the two password fields
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-slate-50 relative overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[500px] bg-gradient-to-b from-blue-400/20 to-transparent blur-3xl rounded-full pointer-events-none"></div>
            <div className="w-full max-w-5xl bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/60 overflow-hidden flex flex-col md:flex-row relative z-10 border border-white">
                ...
                {/* LEFT SIDE OF CARD */}
                <div className="md:w-5/12 bg-slate-900 p-10 lg:p-14 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <Link href="/" className="inline-flex items-center gap-3 mb-12 hover:opacity-90 transition-opacity">
                            ...
                            <span className="text-3xl font-black text-white tracking-tight">Rent<span className="text-blue-500">Flow</span></span>
                        </Link>
                    </div>

                    <div className="relative z-10 mt-auto">
                        <h2 className="text-4xl font-bold text-white mb-4 leading-tight">Start your stay<br />with us.</h2>
                        <p className="text-slate-400 leading-relaxed max-w-xs">Apply for residency to access your portal and manage your accommodations.</p>
                    </div>
                </div>
                ...
                <div className="md:w-7/12 p-10 lg:p-14 bg-white flex flex-col justify-center">
                    <div className="mb-8">
                        ...
                        <p className="text-slate-500">Please enter your details to apply for residency.</p>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div className="sm:col-span-2">
                                ...
                                <input type="text" placeholder="Christian S. Natividad" className="w-full bg-slate-50/50 border border-slate-200 text-slate-900 placeholder-slate-400 px-5 py-4 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 focus:bg-white outline-none transition-all text-sm font-medium" onChange={(e) => setName(e.target.value)} required />
                            </div>

                            <div className="sm:col-span-2">
                                <label className="block text-sm font-bold text-slate-700 mb-2">Email Address</label>
                                <input type="email" placeholder="name@gmail.com" className="w-full bg-slate-50/50 border border-slate-200 text-slate-900 placeholder-slate-400 px-5 py-4 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 focus:bg-white outline-none transition-all text-sm font-medium" onChange={(e) => setEmail(e.target.value)} required />
                            </div>

                            {/* NEW: Primary Password with Eye Toggle */}
                            <div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm font-medium text-slate-500">Already have an account? <Link href="/login" className="text-blue-600 font-bold hover:text-blue-700 transition-colors underline decoration-blue-200 underline-offset-4">Log in here</Link></p>
                    </div>
                </div>
            </div>
        </div>
