            ...
            <div className="w-full max-w-5xl bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/60 overflow-hidden flex flex-col md:flex-row relative z-10 border border-white">
                ...
                <div className="md:w-5/12 bg-slate-900 p-10 lg:p-14 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10 mt-auto">
                        <h2 className="text-4xl font-bold text-white mb-4 leading-tight">Welcome!!<br />to RentFlow.</h2>
                        <p className="text-slate-400 leading-relaxed max-w-xs">Access your portal to pay bills, submit maintenance requests, and connect with management.</p>
                    </div>
                </div>
                {/* RIGHT SIDE OF CARD */}
                <div className="md:w-7/12 p-10 lg:p-14 bg-white flex flex-col justify-center">
                    <div className="mb-8">
                        <h2 className="text-3xl font-bold text-slate-900 tracking-tight mb-2">Log-in Your Account</h2>
                    ...
                    {isNewlyRegistered && !errorMsg && (
                        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-2xl text-green-700 text-sm font-semibold flex items-start">
                            <svg className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div>
                            ...
                            {/* NEW: Relative wrapper & Toggle Button */}
